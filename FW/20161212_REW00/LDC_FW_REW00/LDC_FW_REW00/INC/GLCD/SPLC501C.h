...
#define LCD_RST_H	(PORTD |= 0x10)
#define LCD_RST_L	(PORTD &= ~0x10)
#define LCD_A0_H	(PORTD |= 0x20)
#define LCD_A0_L	(PORTD &= ~0x20)
#define LCD_CS1_H	(PORTD |= 0x08)
#define LCD_CS1_L	(PORTD &= ~0x08)
#define LCD_SCL_H	(PORTD |= 0x40)
#define LCD_SCL_L	(PORTD &= ~0x40)
#define LCD_SI_H	(PORTD |= 0x80)
#define LCD_SI_L	(PORTD &= ~0x80)
